...
export default function VorlageAdhs() {
  return (
    <RoutinePrintSheet
      ...
      clipLane
      steps={[
        { img: 'wake.webp', icon: '💡', label: 'Aufwachen', hint: 'Rollo hoch, ein Schluck Wasser.' },
    ...
    >
      <VorlageGuide
        ...
        previewAlt="Das PDF der ADHS-Vorlage Mein Morgen: sechs Schritte mit je einem Bild und einem Wort (Aufwachen, Klo, Anziehen, Frühstück, Zähne, Ranzen), ein Rand für die Wäscheklammer, Kreise zum Ausmalen, oben Ronki, und ein Zeitbalken ohne Uhrzeit."
